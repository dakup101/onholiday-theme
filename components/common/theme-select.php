...
<?php if ($args["multiple"]) : echo "multiple";
    ...
    <?php if ($args["selected"]) echo 'data-selected="' . $args["selected"] . '"' ?>>
    <?php if ($args["multiple"]) : ?>
    <input class="multiple-value hidden" type="text" name="multiple-<?php echo $args["name"] ?>"
        id="multiple-<?php echo $args["name"]; ?>">
    <?php endif; ?>

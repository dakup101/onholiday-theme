                    ...
                    <li class="megamenu-item">
                        <div class="megamenu-item-content">
                            ...
                            <a href="<?php echo $child['url'] ?>"
                               class="btn btn-accent btn-content megamenu-item-link"
                        ...
                        <figure class="megamenu-item-bg">
                            <div class="megamenu-item-bg-content">
                                <img src="<?php echo $child['bg_img'] ?>"
                                     alt="<?php echo $child['title'] ?>"
                                     loading="lazy">
                ...
                <ul>
                    ...
                    <li class="header-nav-subitem">
                        <a href="<?php echo $nav["submenus"][$sub_child]["url"] ?> "
                           title="<?php echo isset($nav["submenus"][$sub_child]["title_attr"]) ? $nav["submenus"][$sub_child]["title_attr"] : "" ?>"
                           class="header-nav-item-link">
                            <span class="header-nav-item-content">

    ...
    <div class="container">
        ...
        <div class="search-form-item search-date">
            ...
            <label class="select-value-wrapper search-date-value" for="startDate">
                ...
                <div class="select-value" data-name="Daty pobytu">
                    <input type="hidden" id="startDate" placeholder="Wybierz daty pobytu" data-input class="startDate" required value="" />
                </div>
            </label>
        </div>
        <!-- People -->
        ...
        <div class="search-form-item">
            ...
            foreach ($addons as $addon) {
                $addons_array[$addon->slug] = $addon->name . " (" . $addon->count . ")";
            }
        ...
        <!-- Search -->
        <form class="search-form-item search-backend" action="/apartamenty/" method="POST">
            <input type="hidden" name="searchLocation" id="searchLocation">
            <input type="hidden" name="searchGuests" id="searchGuests">
            <input type="hidden" name="searchAddons" id="searchAddons">
            <input type="hidden" name="searchDates" id="searchDates">

    ...
    <form class="ido-inner" method="POST" action="/wp-admin/admin.php?page=idobooking">
        ...
        <div class="ido-input-group">
            ...
            <input type="text" id="clientID" name="clientID"
                value="<?php if (!empty($client)) echo $client->systemClient ?>">
        </div>
        <div class="ido-input-group">
            <label for="clientLogin">Login klient (e-mail):</label>
            <input type="email" id="clientLogin" name="clientLogin"
                value="<?php if (!empty($client)) echo $client->systemLogin ?>">
        </div>
        <div class="ido-input-group">
            <label for="clientPwd">Hasło:</label>
            <input type="password" id="clientPWD" name="clientPWD"
                value="<?php if (!empty($client)) echo $client->systemPwd ?>">
        </div>

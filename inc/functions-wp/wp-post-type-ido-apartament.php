...
function post_type_ido_apartaments()
{
    ...
    $labels = array(
        'name'                  => _x('OH Apartamenty', 'Post Type General Name', 'text_domain'),
        'singular_name'         => _x('OH Apartament', 'Post Type Singular Name', 'text_domain'),
        'menu_name'             => __('IdoBooking Apartamenty', 'text_domain'),
        'name_admin_bar'        => __('IdoBooking Apartamenty', 'text_domain'),
        'archives'              => __('IdoBooking Apartamenty', 'text_domain'),
